...
function closeTest() {
    window.location.replace("http://localhost/gta/exam/dashboard.php");
...
function testOver() {
    ...
    $.ajax({
        url: "prepareTest.php", success: function (result) {

            document.getElementById('container').innerHTML = "<div class='alert alert-info text-center alert-rounded'>" + result + "</div><p id='res_box' ><input class='btn btn-' style='margin:auto;background: #ee0f0f; border-color:ee0f0f;color: white;' type='button' value='Close' onclick='closeTest();' ></p>";
